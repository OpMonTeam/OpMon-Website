function linuxDown(){
    goTo("https://github.com/cyrielcentori/OpMon/releases/download/alpha-v" + version + "/OpMon-" + version  + "-Linux.deb");
}
function macDown(){
    ...
    //goTo("https://github.com/cyrielcentori/OpMon/releases/download/alpha-v" + version + "/OpMon-Mac_" + version + ".dmg");
}
...
function instruction(){
    ...
    goTo("https://github.com/cyrielcentori/OpMon/archive/master.zip");
}
...
var textFr = {
    ...
    winNIDown : '<a href="https://github.com/cyrielcentori/OpMon/releases/download/alpha-v' + version + '/OpMon-Win_NoInstall.zip" class="wow fadeInUp btn btn-default hvr-bounce-to-top smoothScroll" data-wow-delay="1.3s" id="winNIDown">Télécharger pour Windows (Sans installation)</a>',
    ...
    linDown : '<a href="https://github.com/cyrielcentori/OpMon/releases/download/alpha-v' + version + '/OpMon-Linux_NoInstall.zip" class="wow fadeInUp btn btn-default hvr-bounce-to-top smoothScroll" data-wow-delay="1.3s"> Télécharger pour Linux (SFML 2.5)</a>',
...
var textEn = {
    ...
    winNIDown : '<a href="https://github.com/cyrielcentori/OpMon/releases/download/alpha-v' + version + '/OpMon-Win_NoInstall.zip" class="wow fadeInUp btn btn-default hvr-bounce-to-top smoothScroll" data-wow-delay="1.3s" id="winNIDown">Download for Windows (Without installation)</a>',
    ...
    linDown : '<a href="https://github.com/cyrielcentori/OpMon/releases/download/alpha-v' + version + '/OpMon-Linux_NoInstall.zip" class="wow fadeInUp btn btn-default hvr-bounce-to-top smoothScroll" data-wow-delay="1.3s">Download for Linux (SFML 2.5)</a>',
